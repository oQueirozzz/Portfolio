            ...
            <div class="all">
                ...
                <div class="center">
                    ...
                    <div class="explainer"><span>
                                ...
                                <div class="relative">
                                    <div class="group peer relative z-10 p-1">
                                        <svg
                                            ...
                                            <path
                                                d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22c-5.518 0-10-4.482-10-10s4.482-10 10-10 10 4.482 10 10-4.482 10-10 10zm-1-16h2v6h-2zm0 8h2v2h-2z"></path>
                                        </svg>
                                    </div>
                            ...
                            <!-- <img src="img/6936487_click_computer_mouse_mousepad_icon.png"  alt=""> -->
                        </span>

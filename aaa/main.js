...
$(document).on("mousemove", function (e) {
	// Check if the ball is being aimed
	if ($(".ball__aimer").length) {
		...
		// Update the angle of the aim line
		...
		// Update the width of the aim line
		$(".ball__aimer span").css("width", pull + "px");
	}
});

/**
 * Handles the mouse up event, after the user has released the ball
 * @param {Event} e - The event object
 */

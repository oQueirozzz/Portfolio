    ...
    <header>
        <nav class="social">
            <ul>
                ...
                <li><a href="../index.php">English <img src="../imgs/usa.webp" alt=""></a></li>
    ...
    <main>
        <div class="container">
            <div class="all">
                ...
                <div class="left" onclick="window.location.href='sobre-en.php';"> 
                    <div class="text">About Me</div>
                </div>
                <div class="center" onclick="window.location.href='projetos-en.php';">
                    <a href="projetos/projetos.php"></a>
                    <div class="explainer"style="position: absolute; top: 0; left: 0;">
                </div>
                    <div class="text">My Projects</div>
                </div>
                <div class="right"> <a href="habilidades-en.php"></a>
